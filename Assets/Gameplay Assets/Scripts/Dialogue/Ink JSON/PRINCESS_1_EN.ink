...
The villain Torgath has taken advantage of the instability in the kingdom and broken the seal that held back the darkness.
...
This flower <color=\#F8FF30>nilúria</color> can resist the darkness. I don't know why the flower has such power.
According to legend, the last seed of the <color=\#F8FF30>Telurín</color> tree was defiled and could not bloom. The sun illuminated it with its light, and a flower sprang up from the seed. The flower was named <color=\#F8FF30>nilúria</color>, which means “illuminated by light.” It has been able to resist evil ever since.  
->END
