...
+[Не знаю, не уверен]
 ...
 - Почему это ты не уверен ?! Ты же <b><color=\#5B81FF>должен</color></b> знать кто ты такой и зачем пришёл. Хотя погоди Кажется я знаю кто ты, ты похож на нашего спасителя. Видимо ты и прибыл по зову принцессы Спасти её хочешь? #layout:left #speaker:Lemas #portrait:heroFace
 + [...]
 ...
 +[Хорошо, а где мои 16 всадников?]
  ...
  = purpose
  Вы должны раздобыть три ключа в лесу. С помощью клчюей открыть клетку, рядом с которой я нахожусь. А дальше возьмите флягу и идите к святому источнику в этом лесу. Наполните флягу водой и полейте святой водой цветок. #layout:right #speaker:WizardCage #portrait:wizardFace
