...
=== main ===
Я ждал тебя. Наконец ты прошёл все испытания, осталось последнее. Цветок не только может спасти принцессу, но и дать власть тому, кто его использует. Поэтому задам тебе вопрос
~ mainVarBoss = true
->prePurpose
...
= exit 
Рыцарь тебе рано приходить ко мне. Сначала пройди испытания, которые для тебя подготовили мои братья
->END

= finishedBoss
Ты доказал, что тебе можно доверять, держи флягу и наполни её водой из святого источника. 
И ещё одно.
Спасибо тебе
->END