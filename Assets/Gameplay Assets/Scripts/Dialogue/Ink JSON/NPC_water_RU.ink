...
= purpose
Чтобы пройти испытание, вы должны правильно направить русло реки. В некоторых местах река заражена тьмой, но это можно преодолеть, главное будьте внимательны. Я доверяю вашему чутью, поэтому в остальные деталях вы разберётесь сами. 
