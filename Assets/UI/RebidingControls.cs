...
/// </summary>
public class RebidingControls : MonoBehaviour
{
    /// <summary>
    ...
    protected void OnEnable()
    {
        if (s_RebindActionUIs == null)
            s_RebindActionUIs = new List<RebidingControls>();
    ...
    private static List<RebidingControls> s_RebindActionUIs;
    ...
    [Serializable]
    public class UpdateBindingUIEvent : UnityEvent<RebidingControls, string, string, string>
    {
    }

    [Serializable]
    public class InteractiveRebindEvent : UnityEvent<RebidingControls, InputActionRebindingExtensions.RebindingOperation>
    {
    }
}
