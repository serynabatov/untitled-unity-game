...
public class DialogueManager : MonoBehaviour
{
    ...
    private void Start()
    {
     ...
     //TODO: Переместить нагрузку метода на НПС. Тоже его в абстракт закинем (с) Серый
    private void NPCDialogueFunction(string variableName, object variableState)
    {
    ...
    public void EnterDialogueMode(TextAsset inkJSON, GameObject dialogueObject, List<string> observedVariablesList)
    {
        ...
        if (jsonLoad != null)
        {
            ...
            this.currentStory.variablesState["isRunning"] = nPCOneModel.isRunning;
        }
